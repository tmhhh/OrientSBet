...
export default function StatisticProfile() {
  return (
    <ScrollView>
      <ImageBackground
      ...
      <View style={styles.body}>
        ...
        <View style={styles.row}>
          <Text style={styles.title}>Last bet day:</Text>
          <Text style={styles.value}>12/06/2022</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.title}>Dept:</Text>
          <Text style={styles.value}>10.000</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.title}>Number of win matches:</Text>
          <Text style={styles.value}>5</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.title}>Number of lose matches:</Text>
          <Text style={styles.value}>5</Text>
        </View>
        <View style={styles.row}>
